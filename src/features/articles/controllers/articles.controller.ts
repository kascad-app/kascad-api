...
export class ArticlesController {
  ...
  @Post()
  @ApiOperation({ summary: 'Create article', description: 'Creates a new article' })
  ...
  @Get()
  @ApiOperation({ summary: 'Get all articles', description: 'Retrieves a list of all articles' })
  ...
  @Get(":id")
  @ApiOperation({ summary: 'Get article by ID', description: 'Retrieves a specific article by its ID' })
  ...
  @Put(":id")
  @ApiOperation({ summary: 'Update article', description: 'Updates an existing article' })
  @ApiParam({ name: 'id', type: String, description: 'Article ID' })
  ...
  @Delete(":id")
  @ApiOperation({ summary: 'Delete article', description: 'Deletes an existing article' })
  @ApiParam({ name: 'id', type: String, description: 'Article ID' })
