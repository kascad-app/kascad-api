...
export class RiderAuthController {
  ...
  @Get("me")
  @ApiOperation({ summary: 'Get current rider profile', description: 'Retrieves the authenticated rider profile information' })
  @ApiBearerAuth()
  @ApiResponse({ status: 200, description: 'Rider profile retrieved successfully' })
  ...
  @Post("register")
  @ApiOperation({ summary: 'Register new rider', description: 'Creates a new rider account and returns authentication tokens' })
  ...
  @Post("login")
  @ApiOperation({ summary: 'Login rider', description: 'Authenticates a rider and returns authentication tokens' })
  ...
  @Post("logout")
  @ApiOperation({ summary: 'Logout rider', description: 'Logs out the rider by clearing authentication cookies' })
