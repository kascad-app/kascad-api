...
export class SavedSearchController {
  ...
  @Get(":userId")
  @ApiOperation({ summary: 'Get user saved searches', description: 'Retrieves all saved searches for a specific user' })
  ...
  @Post()
  @ApiOperation({ summary: 'Create saved search', description: 'Creates a new saved search for the user' })
  ...
  @ApiOperation({ summary: 'Update saved search', description: 'Updates an existing saved search' })
  @ApiParam({ name: 'userId', type: String, description: 'User ID' })
  @ApiParam({ name: 'savedSearchId', type: String, description: 'Saved search ID' })
  ...
  @ApiOperation({ summary: 'Delete saved search', description: 'Deletes an existing saved search' })
  @ApiParam({ name: 'userId', type: String, description: 'User ID' })
  @ApiParam({ name: 'savedSearchId', type: String, description: 'Saved search ID' })
