...
export class ApplicationController {
  ...
  @ApiOperation({
    summary: "Accept rider application",
    description: "Accepts a rider application for an offer (sponsor only)",
  })
  ...
  @ApiOperation({
    summary: "Reject rider application",
    description: "Rejects a rider application for an offer (sponsor only)",
  })
  @ApiParam({ name: "offerId", type: String, description: "Offer ID" })
  @ApiParam({ name: "riderId", type: String, description: "Rider ID" })
  @ApiResponse({
  ...
  @Get()
  @ApiOperation({
    summary: "Get rider applications",
    description:
      "Retrieves paginated list of applications for the authenticated rider",
  })
  @ApiQuery({
    name: "page",
    required: false,
  ...
  @ApiResponse({
    status: 400,
    description: "Bad request - Not a rider account",
  })
  @ApiResponse({
    status: 401,
    description: "Unauthorized - Invalid or missing token",
