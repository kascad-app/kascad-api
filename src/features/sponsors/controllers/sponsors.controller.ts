...
export class SponsorsController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get all sponsors', description: 'Retrieves a list of all sponsors' })
  @ApiResponse({ status: 200, description: 'List of sponsors retrieved successfully' })
  ...
  @Get(":id")
  @ApiOperation({ summary: 'Get sponsor by ID', description: 'Retrieves a specific sponsor by their ID' })
  ...
  @Post()
  @ApiOperation({ summary: 'Create new sponsor', description: 'Creates a new sponsor account' })
  ...
  @Put(":id")
  @ApiOperation({ summary: 'Update sponsor', description: 'Updates an existing sponsor account' })
  @ApiParam({ name: 'id', type: String, description: 'Sponsor ID' })
  ...
  @Delete(":id")
  @ApiOperation({ summary: 'Delete sponsor', description: 'Deletes a sponsor account' })
  @ApiParam({ name: 'id', type: String, description: 'Sponsor ID' })
